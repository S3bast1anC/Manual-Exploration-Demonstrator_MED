...
Adafruit_DCMotor *R_MOTOR1 = AFMS.getMotor(1);
Adafruit_DCMotor *R_MOTOR2 = AFMS.getMotor(2);
Adafruit_DCMotor *L_MOTOR1 = AFMS.getMotor(3);
Adafruit_DCMotor *L_MOTOR2 = AFMS.getMotor(4);
...
bool accelMode(){
  if (packetbuffer[1] == 'A') {
        ...
        if( y >= 0.1 ){
          ...
          L_MOTOR1->setSpeed( velocity * Lpercent ); 
          L_MOTOR2->setSpeed( velocity * Lpercent ); 
          R_MOTOR1->setSpeed( velocity * Rpercent ); 
          R_MOTOR2->setSpeed( velocity * Rpercent );
 ...
 // Buttons
  ...
  Serial.println(isMoving);
    if (pressed) {
      ...
      if(buttnum == 1){ //forward-left
        L_MOTOR1->run(Forward50);
        L_MOTOR2->run(Forward50);
        R_MOTOR1->run(FORWARD);        
        R_MOTOR2->run(FORWARD);     
      }

      if(buttnum == 2){ //forward-right
        L_MOTOR1->run(FORWARD);
        L_MOTOR2->run(FORWARD);
        R_MOTOR1->run(RELEASE);        
        R_MOTOR2->run(RELEASE);     
      ...
      lastPress = millis();
        ...
        L_MOTOR1->setSpeed(230); 
        L_MOTOR2->setSpeed(230); 
        R_MOTOR1->setSpeed(230);  
        R_MOTOR2->setSpeed(230);  
    } 
